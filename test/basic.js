...
assert.equal(Color("rgb(0,10,20)").toString(), "rgb(0, 10, 20)");
assert.equal(Color("rgba(0,10,20,.2)").toString(), "rgba(0, 10, 20, 0.2)");
assert.equal(Color("hsl(0,10%,20%)").toString(), "hsl(0, 10%, 20%)");
